...
- 英語に限定されない一般的な会話や複数分野にまたがる会話は、ルートの `conversations/YYYY-MM-DD-<topic>.md` に記録する
- 複数分野にまたがる会話から英語部分を残す場合は、会話全体を `conversations/` に置き、英語部分の要点だけを `English/details/` に記録する
